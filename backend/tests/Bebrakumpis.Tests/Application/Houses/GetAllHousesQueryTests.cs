...
public class GetAllHousesQueryTests
{
    ...
    public async Task HandleAsync_ShouldReturnAllHouses_WhenHousesExist()
    {
        ...
        {
            new() { Id = Guid.NewGuid(), Name = "Namas 1", BookingColor = "#3b82f6", ReservedColor = "#ef4444", CreatedAt = DateTime.UtcNow },
            new() { Id = Guid.NewGuid(), Name = "Namas 2", BookingColor = "#10b981", ReservedColor = "#f59e0b", CreatedAt = DateTime.UtcNow }
        };
